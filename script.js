...
function normalizeArabic(text) {
    if (!text) return '';
    return text.replace(/[أconst API_URL = 'https://script.google.com/macros/s/AKfycbyuz1YEiconjtm4Cz8KT9-D91tYVPqA_uJ0QVnf5mH5P3zeELjbsYRK6kYPBzinqHlb3Q/exec';
